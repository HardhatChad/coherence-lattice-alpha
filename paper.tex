...
Define the \emph{intelligence flux}
\begin{equation}\label{eq:I-def}
I(t) := \frac{d\mathcal{C}}{dt} = \frac{d}{dt}\bigl(\Iphase(t) \cdot \rho(t)\bigr).
\end{equation}
...
\begin{proof}
By the product rule:
$I = \Iphase \cdot d\rho/dt + \rho \cdot d\Iphase/dt$.
...
\begin{remark}[Substrate-agnostic principle]\label{rem:core-equation}
Equation~\eqref{eq:ascent} is the central principle of the broader coherence-lattice framework~\cite{Sharpe2026Coherence}: under the CLR and legality, the intelligence flux of any coupled-oscillator substrate is non-negative. The present paper is one specific application of this principle---to the phase sector of the 3D diamond lattice, at its BKT critical point. The same inequality governs all other substrates in which coupled degrees of freedom self-organize by the CLR.
\end{remark}
